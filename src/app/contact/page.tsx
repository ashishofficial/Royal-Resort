        ...
        <Container className="py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a
              ...
              className="flex items-start gap-4 p-5 rounded-xl border border-[var(--color-line)] hover:border-[#0c6131] hover:shadow-md transition-all"
            >
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#0c6131] text-white">
